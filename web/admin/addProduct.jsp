...
<html lang="en">
    <head>
        ...
        <title>Add Product | ${initParam['webName']}</title>
    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <form id="basicInfoForm" class="form-elements-wrapper">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="input-style-1">
                                                ...
                                                <input type="text" name="name" id="name" placeholder="e.g: Chair, iPhone,..." />
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                        ...
                        <div class="card-style d-flex position-sticky justify-content-end gap-3 shadow-lg py-3" style="z-index: 100; bottom: 1.5rem">
                            ...
                            <button type="button" class="btn btn-success" id="submitBtn">Post</button>
                        </div>
                    </form>
                </div>
            </section>
        ...
        <script>
            ...
            let deleteImageBtns;
            let previewImageArr = []; //PRODUCT IMAGES
            ...
            const reRender = () => {
                ...
                removeValueBtns.forEach((btn) => {
                    btn.onclick = () => {
                        ...
                        if (options[`\${btn.dataset.option}`].length === 0)
                            delete options[`\${btn.dataset.option}`]
                        reRender();
                    }
                })
            ...
            submitBtn.onclick = () => {
                ...
                data.append("slug", generateSlugByName(productName.value));
