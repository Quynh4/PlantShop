...
public class DeleteCategory extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean check = cateDAO.deleteCategory(cateId);
            if (check) {
                Map<Integer, String> listCategories = cateDAO.getCategories();
                session.setAttribute("listCategories", listCategories);
                request.setAttribute("MSG_SUCCESS", "You have successfully deleted category!");
            } else {
                request.setAttribute("MSG_ERROR", "You can only delete empty category");
            }
