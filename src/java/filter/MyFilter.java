...
public class MyFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (url.contains("AdminHomeController")||
                url.contains("AdminManageOrderController") ||
                url.contains("AdminManageAccountController")
                || url.contains("AdminManagePlantController")
                || url.contains("AdminManageCategoryController")) {
            ...
            else res.sendRedirect("HomeController");
        }
